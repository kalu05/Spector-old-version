...
run: async (bot, message, args) => {
        ...
        if (!message.guild.me.hasPermission("MANAGE_ROLES")) return message.channel.send("<:recluse8:827723422074535936> **I Dont Have The Permissions To Add Roles To Users! - [MANAGE_ROLES]**> ");
